...
#   movies = Movie.create([{ name: "Star Wars" }, { name: "Lord of the Rings" }])
  ...
  Product.create(vendor_id: 1, subcategory_id: 1, name: "Chino", price: 10, description: "Invoice generator", image: "http://gg.png")
  Product.create(vendor_id: 1, subcategory_id: 1, name: "Chino", price: 100, description: "Invoice generator", image: "http://gg.png")
  Order.create(user_id: 1, product_id: 2, quantity: 1, total_price: 108, )
